                                 ...
                                 <div class="card-body">
                                    ...
                                    <div class="review-item">
                                       <div class="review-header">
                                          <span
                                             class="review-name"><?= htmlspecialchars($danhGia['nguoi_danh_gia']) ?></span>
                                          <span><?php
                                          ...
                                          <span
                                             class="review-date"><?= htmlspecialchars($danhGia['ngay_danh_gia']) ?></span>
                                       </div>
                                    </div>
                                    <?php endforeach; ?>
                                    <?php else : ?>
                           ...
                           <div class="tab-content reviews-tab">
                              <div class="card">
                                 ...
                                 <form action="index.php?act=add-binhluan" method="POST" class="review-form">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-large">Gửi bình luận</button>
                                 </form>
                                 <?php else: ?>
                                 <!-- Thông báo khi chưa đăng nhập -->
                                 <p class="text-muted">Bạn cần <a href="index.php?act=login">đăng
                                    nhập</a> để thêm bình luận.
                                 </p>
                                 <?php endif; ?>
                              </div>
                           </div>
